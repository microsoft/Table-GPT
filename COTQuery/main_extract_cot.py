...
pred_path = os.path.join(args.data_dir, f"cot_data_v{args.version}", "query_data", args.mode, "preds", "modelD3_vanilla.jsonl") 
...
for _, row in preds.iterrows():
    ...
    cot = extract_json_answer(raw_cot, "explanation")
    if cot == "JSONParsingError":
        continue
