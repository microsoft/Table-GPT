...
result_dir = "main_result_chat"
method_alias = {
    "ChatGPT": ["Result-SecondBaseModel-Vanilla-ModelD-chat-002-FinalData___Test-UnseenAndSeenExcludeEM-Size_26489"],
    "TableGPT": ["Result-SecondBaseModel-ModelD-chat-002___TrainData-FinalDatav4-PerturbSample_0_2-Size_17909___TestData-All-Size_78273"]
}
...
def stack_method(df):
    ...
    columns = ["ChatGPT Zero-Shot", "ChatGPT Few-Shot", "TableGPT Zero-Shot", "TableGPT Few-Shot"]
...
result_df.to_excel(makedir(["report_data", "result_chat"], "main_result.xlsx"), index=False)

avg_df = compute_avg(result_df)
avg_df.to_excel(makedir(["report_data", "result_chat"], "main_result_avg.xlsx"), index=False)

avg_stack_df = stack_method(avg_df)
avg_stack_df.to_excel(makedir(["report_data", "result_chat"], "main_result_avg_stack.xlsx"), index=False)
# print(result_df)
