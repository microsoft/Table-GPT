...
parser.add_argument("--data_version", default="11.18")
...
if args.mode == "train":
    save_folder = f"TrainData-data_em_finetune_v{data_version}"
elif args.mode == "val":
...
for task in args.task:
    ...
    root_data_dir = os.path.join(args.root_dir, f"data_em_finetune_{args.data_version}")
